...
from MCMG_utils.data_structs_GM import MolData, Vocabulary
...
def train(train_data, valid_data, model, optim, num_epochs,save_prior_path):
    ...
    for epoch in range(num_epochs):
        ...
        print('average epoch loss:', total_loss / len(train_data),flush=True)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--train-data', action='store', dest='train_data',default='./data/train_data_smiles_qed_sa.csv')
    parser.add_argument('--valid-data', action='store', dest='valid_data',default='./data/valid_data_smiles_qed_sa.csv')
